    ...
    <div>
      {open && (
        <Modal
          ...
          ariaHideApp={false}
          className="max-w-lg w-[90%] absolute top-24 left-[50%] translate-x-[-50%] bg-white border-gray-200 rounded-xl shadow-md"
        >
          <div className="p-4">
            ...
            <div className="flex p-3 space-x-3">
              <img
                ...
                alt="user-img"
                className="size-11 cursor-pointer rounded-full hover:brightness-95"
              />
